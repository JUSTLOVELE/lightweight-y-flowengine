...
public abstract class Base {
     ...
     * @return
     */
    public String renderEditSuccessList(int total) {
        return renderSuccessList(total, null, CommonConstant.SUCCESS_EDIT_MSG);
    }
     ...
     * @return
     */
    public String renderDeleteSuccessList(int total) {
        return renderSuccessList(total, null, CommonConstant.SUCCESS_DELETE_MSG);
    }
     ...
     * @return
     */
    public String renderUpdateSuccessList(int total) {
        return renderSuccessList(total, null, CommonConstant.SUCCESS_UPDATE_MSG);
    }
