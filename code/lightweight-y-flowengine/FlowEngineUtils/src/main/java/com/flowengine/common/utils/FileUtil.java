...
public class FileUtil {
	...
	private final static Log _logger = LogFactory.getLog(FileUtil.class);
...
//	}
	...
	public static String reNameFileWithUUID(String originalFilename) {
		 return UUIDGenerator.getUUID() + "." + getExtName(originalFilename);
	}
	...
	public static boolean deleteFile(String filePath) {
		...
		_logger.info("delete path = " + filePath);
		File file = new File(filePath);
